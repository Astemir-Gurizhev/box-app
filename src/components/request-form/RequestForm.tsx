...
export const RequestForm = () => {
	...
	const handleCreateQuestions = async () => {
		const data = await fetchChatResponse(
			russianRequest +
				clearSymbols +
				'Составь актуальные теоретические вопросы по задаче и создай его в виде массива [], где каждый отдельный элемент это один вопрос в виде строки "" и разделены запятыми без начального объяснения' +
				task
		)
